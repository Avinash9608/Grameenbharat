...
const cultureItems = [
  ...
  { title: 'Farming Lifestyle', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-12 w-12 text-white"><path d="M3 4h9l1 5"/><path d="M4 11V4"/><path d="M8 11V4"/><path d="m10 11 11 5.5"/><circle cx="7" cy="15" r="4"/><circle cx="18" cy="18" r="3"/></svg>, image: 'https://images.unsplash.com/photo-1662815094316-917f52876324?w=600&auto=format&fit=crop', hint: 'indian farmer', href: '/farming' },
];
