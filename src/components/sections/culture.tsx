...
const cultureItems = [
  ...
  { title: 'Village Food & Recipes', icon: <Utensils className="h-10 w-10 text-white" />, image: 'https://images.unsplash.com/photo-1680359873864-43e89bf248ac?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', hint: 'indian food' },
