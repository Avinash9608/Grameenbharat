...
const farmingToolsData = [
    { name: 'Wooden Plough (Hal)', description: 'A traditional tool pulled by oxen to prepare the soil for sowing.', image: 'https://m.media-amazon.com/images/I/61aegKeQOgL._UF894,1000_QL80_.jpg', hint: 'farmer ploughing' },
